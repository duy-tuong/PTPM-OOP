...
public class CreateServicePlanDto
{
    ...
    // Fixed = giá cố định (Prices bên dưới dùng Price/PromotionalPrice). Custom = khách kéo thanh
    // trượt vCPU/RAM/Disk, lúc đó dùng khối Min/Max/Step/PricePerUnit bên dưới, Prices[].Price bị bỏ
    // qua (chỉ DiscountPercent có ý nghĩa) - validate điều kiện ở AdminServicePlanService.
