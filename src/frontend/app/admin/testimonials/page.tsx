            ...
            <PaginationContent>
              <PaginationItem>
                <PaginationPrevious
                  ...
                  aria-disabled={!testimonials.hasPreviousPage}
                />
              </PaginationItem>
              {(() => {
                const total = testimonials.totalPages;
              ...
              <PaginationItem>
                <PaginationNext
                  href={buildPageHref(Math.min(testimonials.totalPages, pageNumber + 1))}
                  aria-disabled={!testimonials.hasNextPage}
                />
              </PaginationItem>
            </PaginationContent>
          </Pagination>
