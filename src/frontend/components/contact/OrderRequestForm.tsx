...
// Nếu có promotion resolve được từ ?promotionCode= (page.tsx): gửi kèm promotionId nhưng KHÔNG claim
// đã áp dụng giảm giá - backend hiện chưa tính khuyến mãi vào totalPrice (hạn chế đã biết, không giấu).
