...
// Section 6/9 của Trang chủ (pivot 2 - theme "Claudverse"). Thay 4 testimonial giả (Alex Nguyen/CTO
    ...
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
      <Reveal className="mb-16 flex flex-col gap-4 text-center">
        ...
        <p className="mx-auto max-w-[600px] text-lg text-muted-foreground">
          Lắng nghe chia sẻ từ những khách hàng đang xây dựng hạ tầng cùng Claudverse.
        </p>
      </Reveal>
