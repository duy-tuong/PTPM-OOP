    ...
    <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="group/bento grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:auto-rows-[190px]">
        <ScrollReveal className="sm:col-span-2 lg:row-span-2">
          <SpotlightCard className="glass-card relative h-full overflow-hidden rounded-3xl transition-opacity duration-500 group-hover/bento:opacity-50 hover:!opacity-100">
        ...
        {VALUES.map((value, index) => (
          <ScrollReveal key={value.title} delay={(index + 1) * 0.08}>
